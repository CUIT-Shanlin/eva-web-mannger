 ...
 * @returns 
 */
export function getUnqualifiedUsers(type = 0, num = 5){
    return request({
        url: `/users/unqualified/${type}/${num}`
    })
}
 ...
 * @returns 分页信息
 */
export function getUnqulifiedPageData(type = 0, reqData = {page: 0,size: 0,queryObj: {}}){
    return request({
        url: `/users/unqualified/${type}`,
        method: 'POST',
        data: reqData
    })
}
